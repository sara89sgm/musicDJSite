...
History: Revised for v2.5.0 (beta3) of SWFUpload.
...
Date: June 12, 2010 - fixed issue with SWFUPLOAD and redirect. Policy stated it, but it didn't need it, so it's been removed. This fixes the '303' error.
Date: October 13, 2010 - distribution updated to v2.5.0 (beta3).
