...
// it also inserts itself into the list and registers it's button to link to the correct reqID
	...
	//alert(dateago);
			var html ="<li id='"+this.id+"'><img src=" +"img/bep.jpg "+" width='600' height='600' /> <h3> " + this.title + "</h3>"+ '<a id="" class="aaa" href="#request-box"></a><a id="" class="bbb" href="#request-box"></a><a id="" class="ccc" href="page1.html"></a>'+'<div style="clear:right;"></div>'+"<h1 style='{font-style:italic;}'>By:"+ this.by + "</h1>"+'<a class="more" onclick="more(this);">More</a> <span class="respond">respond</span></li>'; // more and respond
